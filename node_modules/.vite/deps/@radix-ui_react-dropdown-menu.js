...
function useComposedRefs(...refs) {
  return React10.useCallback(composeRefs2(...refs), refs);
}
...
// node_modules/@radix-ui/react-menu/node_modules/@radix-ui/react-direction/dist/index.mjs
...
var useLayoutEffect23 = (globalThis == null ? void 0 : globalThis.document) ? React20.useLayoutEffect : () => {
};
...
function createSlot3(ownerName) {
  ...
  const Slot22 = React26.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React26.Children.count(newElement) > 1)
            return React26.Children.only(null);
          return React26.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime12.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React26.isValidElement(newElement) ? React26.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function useComposedRefs2(...refs) {
  return React29.useCallback(composeRefs4(...refs), refs);
}
...
function createContextScope3(scopeName, createContextScopeDeps = []) {
  ...
  function createContext32(rootComponentName, defaultContext) {
    ...
    const Provider = (props) => {
      ...
      return (0, import_jsx_runtime15.jsx)(Context.Provider, { value, children });
    };
    Provider.displayName = rootComponentName + "Provider";
    function useContext22(consumerName, scope) {
      var _a;
...
function createSlot4(ownerName) {
  ...
  const Slot22 = React31.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime16.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React31.isValidElement(newElement) ? React31.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var useLayoutEffect24 = (globalThis == null ? void 0 : globalThis.document) ? React34.useLayoutEffect : () => {
};
...
var useLayoutEffect25 = (globalThis == null ? void 0 : globalThis.document) ? React35.useLayoutEffect : () => {
};
...
var PopperAnchor = React37.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : (0, import_jsx_runtime18.jsx)(Primitive4.div, { ...anchorProps, ref: composedRefs });
  }
);
...
var Portal = React38.forwardRef((props, forwardedRef) => {
  var _a;
  const { container: containerProp, ...portalProps } = props;
  const [mounted, setMounted] = React38.useState(false);
  useLayoutEffect23(() => setMounted(true), []);
  const container = containerProp || mounted && ((_a = globalThis == null ? void 0 : globalThis.document) == null ? void 0 : _a.body);
  return container ? import_react_dom2.default.createPortal((0, import_jsx_runtime19.jsx)(Primitive2.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
function useStateMachine(initialState, machine) {
  return React39.useReducer((state, event) => {
...
// node_modules/@radix-ui/react-menu/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var React40 = __toESM(require_react(), 1);
var React211 = __toESM(require_react(), 1);
var useInsertionEffect2 = React40[" useInsertionEffect ".trim().toString()] || useLayoutEffect23;
function useControllableState2({
  ...
  const value = isControlled ? prop : uncontrolledProp;
  if (true) {
    const isControlledRef = React40.useRef(prop !== void 0);
    React40.useEffect(() => {
      const wasControlled = isControlledRef.current;
      if (wasControlled !== isControlled) {
        const from = wasControlled ? "controlled" : "uncontrolled";
  ...
  const setValue = React40.useCallback(
    (nextValue) => {
      var _a;
      if (isControlled) {
...
function useUncontrolledState2({
  ...
  const [value, setValue] = React40.useState(defaultProp);
  const prevValueRef = React40.useRef(value);
  const onChangeRef = React40.useRef(onChange);
  useInsertionEffect2(() => {
    onChangeRef.current = onChange;
  }, [onChange]);
  React40.useEffect(() => {
...
var RovingFocusGroup = React41.forwardRef(
  (props, forwardedRef) => {
    return (0, import_jsx_runtime20.jsx)(Collection.Provider, { scope: props.__scopeRovingFocusGroup, children: (0, import_jsx_runtime20.jsx)(Collection.Slot, { scope: props.__scopeRovingFocusGroup, children: (0, import_jsx_runtime20.jsx)(RovingFocusGroupImpl, { ...props, ref: forwardedRef }) }) });
  }
);
...
var Menu = (props) => {
  ...
  return (0, import_jsx_runtime21.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime21.jsx)(
    MenuProvider,
    {
      scope: __scopeMenu,
      open,
...
var MenuPortal = (props) => {
  ...
  return (0, import_jsx_runtime21.jsx)(PortalProvider, { scope: __scopeMenu, forceMount, children: (0, import_jsx_runtime21.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime21.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var MenuContent = React42.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime21.jsx)(Collection2.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime21.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime21.jsx)(Collection2.Slot, { scope: props.__scopeMenu, children: rootContext.modal ? (0, import_jsx_runtime21.jsx)(MenuRootContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime21.jsx)(MenuRootContentNonModal, { ...contentProps, ref: forwardedRef }) }) }) });
  }
);
...
var Slot5 = createSlot2("MenuContent.ScrollLock");
...
var MenuGroup = React42.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime21.jsx)(Primitive2.div, { role: "group", ...groupProps, ref: forwardedRef });
  }
);
...
var MenuLabel = React42.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime21.jsx)(Primitive2.div, { ...labelProps, ref: forwardedRef });
  }
);
...
var MenuSubContent = React42.forwardRef(
  (props, forwardedRef) => {
    ...
    const ref = React42.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, ref);
    return (0, import_jsx_runtime21.jsx)(Collection2.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime21.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime21.jsx)(Collection2.Slot, { scope: props.__scopeMenu, children: (0, import_jsx_runtime21.jsx)(
      MenuContentImpl,
      {
...
var useReactId2 = React43[" useId ".trim().toString()] || (() => void 0);
var count3 = 0;
