...
export default [
	{ ignores: ['node_modules/**', 'dist/**', 'build/**', 'vite.config.js', 'android/**', 'ios/**', 'api/**', 'plugins/**'] },
	{
		files: ['**/*.js', '**/*.jsx'],
		...
		languageOptions: {
			...
			globals: { ...sanitizedBrowserGlobals, React: 'readonly', Intl: 'readonly' },
		},
		settings: {
		...
		rules: {
			...
			'import/no-unresolved': 'off', // Project uses Vite alias (@) but eslint resolver dependency is not installed
			'import/default': 'off',
			'import/named': 'off',
